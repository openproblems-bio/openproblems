...
assert meta['functionality_name'] in output.uns["metric_id"]

print(">> Checking whether metrics are float")
assert isinstance(adata.uns['metric_values'][adata.uns['metric_ids'].index(meta['functionality_name'])], float)
