...
input_scores: "$DATASETS_DIR/output.run_benchmark.output_scores.yaml"
input_dataset_info: "$DATASETS_DIR/output.run_benchmark.output_dataset_info.yaml"
input_method_configs: "$DATASETS_DIR/output.run_benchmark.output_method_configs.yaml"
input_metric_configs: "$DATASETS_DIR/output.run_benchmark.output_metric_configs.yaml"
input_execution: "$DATASETS_DIR/trace.txt"
input_task_info: "$DATASETS_DIR/output.run_benchmark.task_info.yaml"
