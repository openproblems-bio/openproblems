...
@baseline_method(method_name="Majority Vote", method_summary="TODO", is_baseline=False)
...
@baseline_method(method_name="Random Labels", method_summary="TODO")
...
@baseline_method(method_name="True Labels", method_summary="TODO")
