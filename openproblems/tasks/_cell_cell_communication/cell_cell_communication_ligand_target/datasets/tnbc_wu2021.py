...
@dataset(
    ...
    dataset_summary="A single-cell atlas of human breast cancers (Wu et al., 2021), "
    "along with inferred cytokine activities as assumed true cell-cell communication). "
