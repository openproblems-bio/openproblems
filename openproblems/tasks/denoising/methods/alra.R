...
# cast to as.matrix, so unless as.matrix fails we don't need ALRA to check the class type of train_matrix.
# therefore, use version of ALRA that doesn't check type: https://github.com/wes-lewis/ALRA/blob/master/alra.R
