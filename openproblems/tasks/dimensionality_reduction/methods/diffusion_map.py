...
@method(
    ...
    method_summary=(
        "Diffusion maps is an affinity-based method that attempts to preserve"
        ' "diffusion distances", or graph random walk distances, by embedding data'
        " using the eigenvalue-weighted eigenvectors of the graph Laplacian. Diffusion"
