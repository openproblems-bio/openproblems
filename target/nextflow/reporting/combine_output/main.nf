// combine_output build_feature_no_ref_update_process_results
// 
...
meta = [
  ...
  "name" : "combine_output",
  "namespace" : "reporting",
  "version" : "build_feature_no_ref_update_process_results",
  "argument_groups" : [
    {
      "name" : "Inputs",
      "arguments" : [
        {
          ...
          "example" : [
            "resources_test/openproblems/task_results_v4/processed/task_info.json"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
        ...
        },
        {
          ...
          "example" : [
            "resources_test/openproblems/task_results_v4/processed/quality_control.json"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/reporting/combine_output/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  "input_task_info" = $( if [ ! -z ${VIASH_PAR_INPUT_TASK_INFO+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_TASK_INFO" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  ...
  "input_results" = $( if [ ! -z ${VIASH_PAR_INPUT_RESULTS+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_RESULTS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "input_quality_control" = $( if [ ! -z ${VIASH_PAR_INPUT_QUALITY_CONTROL+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_QUALITY_CONTROL" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/openproblems/reporting/combine_output",
    "tag" : "build_feature_no_ref_update_process_results"
  },
  "label" : [
    "lowmem",
    "lowtime",
