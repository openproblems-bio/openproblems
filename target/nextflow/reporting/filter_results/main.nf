...
meta = [
      ...
      "arguments" : [
        {
          ...
          "description" : "A list of dataset ids to include. If specified, only these datasets will be included.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "A list of dataset ids to exclude. If specified, all datasets except the ones listed will be included.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          ...
          "description" : "A list of method ids to include. If specified, only these methods will be included.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "A list of method ids to exclude. If specified, all methods except the ones listed will be included.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          ...
          "description" : "A list of metric ids to include. If specified, only these metrics will be included.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "A list of metric ids to exclude. If specified, all metrics except the ones listed will be included.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          ...
          "example" : [
            "resources_test/openproblems/task_results_v4/processed/filtered_dataset_info.json"
          ],
          "default" : [
            "filtered_dataset_info.json"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
        ...
        },
        {
          ...
          "example" : [
            "resources_test/openproblems/task_results_v4/processed/filtered_method_info.json"
          ],
          "default" : [
            "filtered_method_info.json"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
        ...
        },
        {
          ...
          "example" : [
            "resources_test/openproblems/task_results_v4/processed/filtered_metric_info.json"
          ],
          "default" : [
            "filtered_metric_info.json"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
        ...
        },
        {
          ...
          "example" : [
            "resources_test/openproblems/task_results_v4/processed/filtered_results.json"
          ],
          "default" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/reporting/filter_results/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/reporting/filter_results",
    "viash_version" : "0.9.4",
    "git_commit" : "76e280c7477ea73c9bb97ae65e22ddb206be3949",
    "git_remote" : "https://github.com/openproblems-bio/openproblems",
    "git_tag" : "v1.0.0-1434-g76e280c7"
  },
  "package_config" : {
    "name" : "openproblems",
    "version" : "build_main",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/openproblems/reporting/filter_results",
    "tag" : "build_main"
  },
  "label" : [
    "lowmem",
