// process_dataset_metadata build_feature_no_ref_update_process_results
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/reporting/process_dataset_metadata/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/reporting/process_dataset_metadata",
    "viash_version" : "0.9.4",
...
include { yaml_to_json } from "${meta.resources_dir}/../../../nextflow/utils/yaml_to_json/main.nf"
