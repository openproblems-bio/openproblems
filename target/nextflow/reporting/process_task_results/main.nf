// process_task_results build_feature_no_ref_update_process_results
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/reporting/process_task_results/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { get_results } from "${meta.resources_dir}/../../../nextflow/reporting/get_results/main.nf"
include { get_method_info } from "${meta.resources_dir}/../../../nextflow/reporting/get_method_info/main.nf"
