// render_report build_feature_no_ref_update_process_results
// 
...
meta = [
      ...
      "arguments" : [
        {
          ...
          "example" : [
            "resources_test/openproblems/task_results_v4/processed/combined_output.json"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/reporting/render_report/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/reporting/render_report",
    "viash_version" : "0.9.4",
...
par <- list(
  "input_task_results" = $( if [ ! -z ${VIASH_PAR_INPUT_TASK_RESULTS+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_TASK_RESULTS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/openproblems/reporting/render_report",
