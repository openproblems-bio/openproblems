// get_dataset_info build_feature_no_ref_update_process_results
// 
...
meta = [
      ...
      "arguments" : [
        {
          ...
          "example" : [
            "resources_test/openproblems/task_results_v4/raw/dataset_uns.yaml"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/reporting/get_dataset_info/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/reporting/get_dataset_info",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/openproblems/reporting/get_dataset_info",
