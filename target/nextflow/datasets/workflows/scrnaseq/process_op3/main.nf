...
meta = [
  ...
  "build_info" : {
    ...
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/datasets/workflows/scrnaseq/process_op3",
    "viash_version" : "0.9.4",
...
include { op3 } from "${meta.resources_dir}/../../../../../nextflow/datasets/loaders/scrnaseq/op3/main.nf"
