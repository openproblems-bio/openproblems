// process_openproblems_op3 build_feature_no_ref_update_process_results
// 
            ...
            "format" : {
              ...
              "obs" : [
                ...
                },
                {
                  "type" : "string",
                  "name" : "tissue_general_ontology_term_id",
                  "description" : "Ontology te''' + '''rm identifier for the general tissue category, aiding in standardizing and grouping tissue types.\n\nFor organoid or tissue samples, the Uber-anatomy ontology (`UBERON:`) is used. The term ids must be a child term of `UBERON:0001062` (anatomical entity).\nFor cell cultures, the Cell Ontology (`CL:`) is used. The term ids cannot be `CL:0000255`, `CL:0000257` or `CL:0000548`.\n",
                  "required" : false
                },
                {
                  "type" : "string",
...
include { openproblems_op3 } from "${meta.resources_dir}/../../../../../nextflow/datasets/loaders/scrnaseq/openproblems_op3/main.nf"
