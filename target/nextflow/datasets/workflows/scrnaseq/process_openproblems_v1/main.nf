// process_openproblems_v1 build_feature_no_ref_update_process_results
// 
...
meta = [
            ...
            "format" : {
              ...
              "obs" : [
                ...
                },
                {
                  "type" : "string",
                  "name" : "tissue_general_ontology_term_id",
                  "description" : "Ontology term identifier for the general tissue category, aiding in standardizing and grouping tissue types.\n\nFor organoid or tissue sa''' + '''mples, the Uber-anatomy ontology (`UBERON:`) is used. The term ids must be a child term of `UBERON:0001062` (anatomical entity).\nFor cell cultures, the Cell Ontology (`CL:`) is used. The term ids cannot be `CL:0000255`, `CL:0000257` or `CL:0000548`.\n",
                  "required" : false
                },
                {
                  "type" : "string",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/datasets/workflows/scrnaseq/process_openproblems_v1/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/datasets/workflows/scrnaseq/process_openproblems_v1",
    "viash_version" : "0.9.4",
...
include { openproblems_v1 } from "${meta.resources_dir}/../../../../../nextflow/datasets/loaders/scrnaseq/openproblems_v1/main.nf"
...
include { extract_uns_metadata } from "${meta.resources_dir}/../../../../../nextflow/utils/extract_uns_metadata/main.nf"
