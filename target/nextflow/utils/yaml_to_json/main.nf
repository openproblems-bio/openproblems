// yaml_to_json build_feature_no_ref_update_process_results
// 
...
meta = [
  ...
  "description" : "This script converts a YAML file to a JSON file.\n",
  "status" : "enabled",
  "scope" : {
    "image" : "public",
    "target" : "public"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/utils/yaml_to_json/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/utils/yaml_to_json",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/openproblems/utils/yaml_to_json",
