// upgrade_config build_feature_no_ref_update_process_results
// 
...
meta = [
  ...
  "description" : "Upgrade a component config from viash version 0.8 to version 0.9. \n",
  "usage" : "viash run upgrade_config/config.vsh.yaml -- --input method --output foo",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/project/upgrade_config/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/openproblems/project/upgrade_config",
