// render_readme build_feature_no_ref_update_process_results
// 
...
meta = [
  ...
  "description" : "Render the task README\n",
  "test_resources" : [
    {
      "type" : "r_script",
      "path" : "test.R",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/project/render_readme/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/project/render_readme",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/openproblems/project/render_readme",
