// create_component build_feature_no_ref_update_process_results
// 
...
meta = [
      ...
      "arguments" : [
        {
          ...
          "default" : [
            "src/${VIASH_PAR_TYPE}s/${VIASH_PAR_NAME}"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
  ...
  "usage" : "create_component --type method --language r --name foo create_component --type metric --language python --name bar",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openproblems/openproblems/src/project/create_component/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/openproblems/project/create_component",
